...
public class LineSeparatorLocator extends LineSeparatorRenderer {
  ...
  public LineSeparatorLocator(LineSeparator modelElement, List<LocationInfo> locations, String name, int times) {
    super(modelElement);
  ...
  public IRenderer getNextRenderer() {
    return new LineSeparatorLocator((LineSeparator) modelElement, locations, name, times + 1);
  }
